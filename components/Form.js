		...
		return (
			<form onSubmit={this.handleSubmit} className='Form'>
				...
				<div className='Form-element'> 
					...
					/>
					<label htmlFor='type0' className='Form-radioLabel'>1- </label>
					<input
						id='type1'
						type='radio'
						value='1'
						...
						className='Form-radio'
					/>
					<label htmlFor='type1' className='Form-radioLabel'>1</label>
					<input
						id='type2'
						type='radio'
						value='2'
						...
						className='Form-radio'
					/>
					<label htmlFor='type2' className='Form-radioLabel'>2</label>
					<input
						id='type3'
						type='radio'
						value='3'
						...
						className='Form-radio'
					/>
					<label htmlFor='type3' className='Form-radioLabel'>3 </label>
					<input
						id='type4'
						type='radio'
						value='4'
						...
						className='Form-radio'
					/>
					<label htmlFor='type4' className='Form-radioLabel'>3+</label>
				</div>
				<div className='Form-element'>
